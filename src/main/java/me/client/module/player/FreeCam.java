...
public class FreeCam extends Module {
    ...
    public FreeCam() {
        super("Freecam", "Libera La Camara Y Conviertete en Espectador", Category.PLAYER);
        Dark.instance.settingsManager.rSetting(new Setting("Speed", this, 1, 1, 10, false));
        Dark.instance.settingsManager.rSetting(new Setting("Desactivar Al Ser Golpeado", this, false));
