...
public class AimAssist extends Module {
    ...
    public AimAssist() {
        ...
        Dark.instance.settingsManager.rSetting(new Setting("FOV", this, 90, 10.0, 180.0, false));
        Dark.instance.settingsManager.rSetting(new Setting("Distance", this, 4.3, 1.0, 10.0, false));
        Dark.instance.settingsManager.rSetting(new Setting("Teams", this ,false));
...
//TODO: Vaya, recuerda si vas a usar cualquier recurso de este src, darme los creditos jeje ya le sabes supongo :)
    ...
    public void tickEvent(final TickEvent.RenderTickEvent event) {
        ...
        boolean teamsActivated = Dark.instance.settingsManager.getSettingByName(this, "Teams").getValBoolean();
        ...
        if ((swordActivado && isSwordInHand()) || !swordActivado) {
    ...
    private Entity ent() {
        ...
        for (Object obj : this.mc.theWorld.loadedEntityList) {
            if (obj instanceof EntityLivingBase) {
                ...
                if (distance < this.distanceValue.getValue()) {
