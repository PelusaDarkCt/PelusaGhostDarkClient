...
public class Keybind extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.func_71410_x().field_71466_p.func_175063_a(binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
		GL11.glPopMatrix();
	}
