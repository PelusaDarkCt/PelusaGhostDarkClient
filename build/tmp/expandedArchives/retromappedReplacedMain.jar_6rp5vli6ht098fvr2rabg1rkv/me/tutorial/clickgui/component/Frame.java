package me.tutorial.clickgui.component;
...
public class Frame {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		...
		fontRenderer.func_175063_a(this.category.name(), (this.x + 2) * 2 + 5, (this.y + 2.5f) * 2 + 5, 0xFFFFFFFF);
		fontRenderer.func_175063_a(this.open ? "-" : "+", (this.x + this.width - 10) * 2 + 5, (this.y + 2.5f) * 2 + 5, -1);
		GL11.glPopMatrix();
		if(this.open) {
